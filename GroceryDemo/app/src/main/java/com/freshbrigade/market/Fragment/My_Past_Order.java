...
import com.freshbrigade.market.Adapter.My_Past_Order_adapter;
import com.freshbrigade.market.Config.BaseURL;
import com.freshbrigade.market.Model.My_Past_order_model;
import com.freshbrigade.market.AppController;
import com.freshbrigade.market.MainActivity;
import com.freshbrigade.market.MyOrderDetail;
import com.freshbrigade.market.util.ConnectivityReceiver;
import com.freshbrigade.market.util.CustomVolleyJsonArrayRequest;
...
public class My_Past_Order extends Fragment {
    ...
    //  private static String TAG = com.freshbrigade.market.Fragment.My_Past_Order.class.getSimpleName();
...
//                    com.freshbrigade.market.Fragment fm = new Home_fragment();
