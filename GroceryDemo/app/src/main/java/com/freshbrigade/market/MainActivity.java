...
import com.freshbrigade.market.Fonts.CustomTypefaceSpan;
import com.freshbrigade.market.Fragment.About_us_fragment;
import com.freshbrigade.market.Fragment.Empty_cart_fragment;
import com.freshbrigade.market.Fragment.Home_fragment;
import com.freshbrigade.market.Fragment.Cart_fragment;
import com.freshbrigade.market.Fragment.Reward_fragment;
import com.freshbrigade.market.Fragment.Edit_profile_fragment;
import com.freshbrigade.market.Fragment.Shop_Now_fragment;
import com.freshbrigade.market.Fragment.Terms_and_Condition_fragment;
import com.freshbrigade.market.Fragment.Wallet_fragment;

import com.freshbrigade.market.networkconnectivity.NetworkError;
...
//            fm.setArguments(args);
//        }
//        else if (id == R.id.nav_my_price) {
//            fm = new Recycle_Main_Activity();
//            args.putString("url", BaseURL.GET_SUPPORT_URL);
//            args.putString("title", getResources().getString(R.string.nav_terms));
//            fm.setArguments(args);
//        }
...
//        }
    ...
    public void shareApp() {
        ...
        sendIntent.putExtra(Intent.EXTRA_TEXT, "Hi friends i am using ." + " http://play.google.com/store/apps/details?id=" + "freshbrigade.company" + " APP");
