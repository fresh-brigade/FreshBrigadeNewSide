...
import com.freshbrigade.market.LoginActivity;
import com.freshbrigade.market.LoginActivity4Number;

import static com.freshbrigade.market.Config.BaseURL.IS_LOGIN;
import static com.freshbrigade.market.Config.BaseURL.KEY_DATE;
import static com.freshbrigade.market.Config.BaseURL.KEY_EMAIL;
import static com.freshbrigade.market.Config.BaseURL.KEY_HOUSE;
import static com.freshbrigade.market.Config.BaseURL.KEY_ID;
import static com.freshbrigade.market.Config.BaseURL.KEY_IMAGE;
import static com.freshbrigade.market.Config.BaseURL.KEY_MOBILE;
import static com.freshbrigade.market.Config.BaseURL.KEY_NAME;
import static com.freshbrigade.market.Config.BaseURL.KEY_PASSWORD;
import static com.freshbrigade.market.Config.BaseURL.KEY_PAYMENT_METHOD;
import static com.freshbrigade.market.Config.BaseURL.KEY_PINCODE;
import static com.freshbrigade.market.Config.BaseURL.KEY_REWARDS_POINTS;
import static com.freshbrigade.market.Config.BaseURL.KEY_SOCITY_ID;
import static com.freshbrigade.market.Config.BaseURL.KEY_SOCITY_NAME;
import static com.freshbrigade.market.Config.BaseURL.KEY_TIME;
import static com.freshbrigade.market.Config.BaseURL.KEY_WALLET_Ammount;
import static com.freshbrigade.market.Config.BaseURL.MOBILE_NUMBER;
import static com.freshbrigade.market.Config.BaseURL.PREFS_NAME;
import static com.freshbrigade.market.Config.BaseURL.PREFS_NAME2;
import static com.freshbrigade.market.Config.BaseURL.TOTAL_AMOUNT;
...
public class Session_management {
    ...
    public void logoutSession() {
        ...
        Intent logout = new Intent(context, LoginActivity4Number.class);

        SharedPref.putBoolean(context,"login",false);
        // Closing all the Activities
