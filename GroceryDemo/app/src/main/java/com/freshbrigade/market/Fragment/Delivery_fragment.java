...
import com.freshbrigade.market.Adapter.Delivery_get_address_adapter;
import com.freshbrigade.market.Config.BaseURL;
import com.freshbrigade.market.Config.SharedPref;
import com.freshbrigade.market.Model.Delivery_address_model;
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (status) {
                        ...
                        //RecyclerView.com.freshbrigade.market.Adapter adapter1 = new Delivery_get_address_adapter(delivery_address_modelList);
