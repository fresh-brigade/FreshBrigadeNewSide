...
//        user_login=channel.getString("checkOtpLogin",null).equals("login");
//        Log.d("valueChack11", String.valueOf(user_login));
//        if(channel.getString("checkOtpLogin",null).equals("login")) {
//            Toast.makeText(getApplicationContext(), String.valueOf(user_login), Toast.LENGTH_LONG).show();
//
...
//        }
    ...
    public void go_next() {
        ...
        boolean isLogin = SharedPref.getBoolean(SplashActivity.this,"login",false);

        Log.e("sadsadsadfasdfasfa", String.valueOf(isLogin));
        ...
        }else
        {
            ...
            Intent startmain = new Intent(SplashActivity.this, LoginActivity4Number.class);
            startActivity(startmain);
        }
