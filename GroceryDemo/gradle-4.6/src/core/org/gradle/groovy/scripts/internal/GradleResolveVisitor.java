...
public class GradleResolveVisitor extends ResolveVisitor {
    ...
    private static final String[] DEFAULT_IMPORTS = {"java.lang.", "java.io.", "java.net.", "java.com.freshbrigade.market.util.", "groovy.lang.", "groovy.com.freshbrigade.market.util."};
    ...
    private boolean resolveFromDefaultImports(ClassNode type, boolean testDefaultImports) {
        ...
        if (testDefaultImports) {
            ...
            if (resolveFromResolver(type, "org.gradle.com.freshbrigade.market.util." + name)) {
