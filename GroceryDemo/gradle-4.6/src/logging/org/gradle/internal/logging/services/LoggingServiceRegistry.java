...
public abstract class LoggingServiceRegistry extends DefaultServiceRegistry {
     ...
     *     <li>Configures slf4j, log4j and java com.freshbrigade.market.util logging to route log messages through the logging system.</li>
     ...
     *     <li>Configure java com.freshbrigade.market.util logging. Use {@link LoggingManagerInternal#captureSystemSources()} to enable this.</li>
