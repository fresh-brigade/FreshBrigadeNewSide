...
public class JavaCompilerArgumentsBuilder {
    ...
    private void addMainOptions(List<String> compilerArgs) {
        ...
        /*This is an internal option, it's used in com.sun.tools.javac.com.freshbrigade.market.util.Names#createTable(Options options). The -XD backdoor switch is used to set it, as described in a comment
