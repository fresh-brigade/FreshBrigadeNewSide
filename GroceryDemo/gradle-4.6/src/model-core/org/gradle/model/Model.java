 ...
 * <p>
 * It is an error for a {@code @com.freshbrigade.market.Model} rule to return {@code void} and specify a non-managed type as the first parameter.
 * It is an error for a {@code @com.freshbrigade.market.Model} rule to return {@code void} and for the first parameter to be annotated with {@link Path}.
 * It is an error for a {@code @com.freshbrigade.market.Model} rule to specify a managed type as the return type.
