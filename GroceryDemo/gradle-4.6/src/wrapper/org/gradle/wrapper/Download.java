...
public class Download implements IDownload {
     ...
     *
     * Try to use {@literal java.com.freshbrigade.market.util.Base64} encoder which is available starting with Java 8.
    ...
    private String base64Encode(String userInfo) {
        ...
        try {
            Method getEncoderMethod = loader.loadClass("java.com.freshbrigade.market.util.Base64").getMethod("getEncoder");
            Method encodeMethod = loader.loadClass("java.com.freshbrigade.market.util.Base64$Encoder").getMethod("encodeToString", byte[].class);
